...
import { exportHealthBureauXls } from '@/lib/healthBureauExport'
...
export default function HealthBureauExportPage() {
  ...
  const handleExport = () => {
    exportHealthBureauXls(visitsInMonth, cases, settings.managerIdNumber, `電訪紀錄_${month}.xlsx`)
  }
    ...
    <div className="max-w-3xl">
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-5 space-y-4">
        ...
        <p className="text-sm text-gray-500">
          本月共 <span className="font-semibold text-[#7a9985]">{visitsInMonth.length}</span> 筆電訪紀錄
        </p>
        ...
        <button
          ...
          disabled={visitsInMonth.length === 0}
      ...
      {visitsInMonth.length > 0 && (
        <div className="bg-white rounded-xl border border-gray-100 p-5 mt-4 overflow-x-auto">
          <h3 className="text-sm font-semibold text-gray-700 mb-3">本月電訪紀錄預覽</h3>
